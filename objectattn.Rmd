...
<br>
<br>
This is the form of attention that we’re interested in capturing with an experimental paradigm. So we designed this simple task for participants to do while we record their EEG: 
<br>
<br>
...
<br>
<br>
We gave all participants a controller with two buttons, and told them: Press button 1 if target image is male face, nature scene, or powered tool; press button 2 if target image is female face, urban scene, or hand tool; do it as fast and accurately as you can. The cue validity was 80%, meaning that 20% of the time, the cue shape would mislead particiapnts and a target image from an uncued object category would appear. All stimuli presented at center fixation. We recorded EEG data from 20 undergraduate participants performing this experiment, with about 400 trials for each participant.
